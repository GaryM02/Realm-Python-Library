...
class configuration:
    ...
    def set_schema_object(self, config_handle, schema_handle):
        ...
        return rlm_lib.realm_config_set_schema(ctypes.c_void_p(config_handle), ctypes.c_void_p(schema_handle))


    def set_schema_version(self, config_handle):
        rlm_lib.realm_config_set_schema_version.restype = ctypes.c_void_p
        return rlm_lib.realm_config_set_schema_version(ctypes.c_void_p(config_handle), 1)


    def set_path_for_realm(self, config_handle, encoded_file):
        rlm_lib.realm_config_set_path.restype = ctypes.c_void_p
        return rlm_lib.realm_config_set_path(ctypes.c_void_p(config_handle), encoded_file)
